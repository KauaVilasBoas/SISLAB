...
public sealed class IdentityModule : IModule
{
    ...
    {
        // SISLAB auth surface (card [E7] #44): login/refresh/logout/register/confirm-email/
        // forgot-password/reset-password/me/change-password. This REPLACES MapLumenIdentityEndpoints
        // (both cannot map the same routes) — it dispatches the same Lumen CQRS commands but bridges
        // login/refresh/logout to httpOnly session cookies for the browser SPA.
        endpoints.MapSislabAuthEndpoints();
