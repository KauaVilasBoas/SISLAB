...
{
    /// <summary>
    /// Seeds the permission codes that gate the in vivo behavioural write endpoints (card [E11] #88 — von Frey /
    /// tail-flick / rota-rod / hemogram). Every <c>[RequirePermission]</c>-gated action on
    /// <c>ExperimentsController</c> must have its code seeded here or it would return 403 for everyone; the
    ...
    /// <c>ExperimentsController</c> actions CreateBehavioral / RecordTimepoint / CalculateBehavioral. They join the
    ...
    /// endpoints.</para>
    /// </summary>
    public partial class SeedBehavioralExperimentPermissions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.SeedLumenPermission(
                "Experiments.CreateBehavioral",
                "Criar teste comportamental (in vivo)",
                ExperimentsGroup);

            migrationBuilder.SeedLumenPermission(
                "Experiments.RecordTimepoint",
                "Lançar leituras de um timepoint",
                ExperimentsGroup);

            migrationBuilder.SeedLumenPermission(
                "Experiments.CalculateBehavioral",
                "Calcular teste comportamental",
                ExperimentsGroup);
        }
